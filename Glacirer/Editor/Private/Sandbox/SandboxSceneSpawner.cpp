...
namespace GlacirerEditor
{
    namespace Sandbox
    {
        ...
        void SandboxSceneSpawner::Spawn(Glacirer::World& world)
        {
            ...
            anotherMaterial->SetTexture("u_Diffuse", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/FancyPigeon.png", "Pigeon", pigeonTextureSettings, true), 1);
        ...
        void SandboxSceneSpawner::SpawnCrates(Glacirer::World& world)
        {
            ...
            crateMaterial->SetTexture("u_Diffuse", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/Container_Diff.png", "Container_Diffuse", Glacirer::Rendering::TextureSettings{false}, true), 1);
            crateMaterial->SetTexture("u_Specular", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/Container_Spec.png", "Container_Specular", Glacirer::Rendering::TextureSettings{false, false}, true), 2);
        ...
        void SandboxSceneSpawner::SpawnBridge(Glacirer::World& world)
        {
            ...
            bridgeMaterial->SetTexture("u_Diffuse", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/Atlas04_Diff.png", "T_Bridge_Diffuse", Glacirer::Rendering::TextureSettings{false}), 1);
        ...
        void SandboxSceneSpawner::SpawnTransparentObjects(Glacirer::World& world)
        {
            ...
            flowerMaterial->SetTexture("u_Diffuse", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/Flower.png", "T_Flower", Glacirer::Rendering::TextureSettings{true}, true), 1);
            ...
            windowMaterial->SetTexture("u_Diffuse", Glacirer::Resources::ResourceManager::LoadTexture(SANDBOX_RESOURCES_PATH + "Textures/TransparentWindow.png", "T_Window", Glacirer::Rendering::TextureSettings{true}, true), 1);
